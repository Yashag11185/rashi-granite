...
const AboutCeo = () => {
  const aboutData = {
    title: {
      ...
      mainTitle: (
        <>
          Providing<span>premium granite</span>solutions globally.
        </>
      ),
    },
    content: {
      ...
      description:
        "With decades of expertise in the stone industry, we are committed to offering top-quality materials and exceptional service. Our team is passionate about helping you create the place of your dreams with stunning, durable stones.",
    },
    rating: {
      text: "We are a trusted supplier in the industry",
      starsCount: 4,
    },
  };
    ...
    <>
      ...
      <div className="col-md-6 order-md-first" data-aos="fade-right">
        <div className="img-meta d-inline-block position-relative ps-3 ps-lg-5 pb-50 sm-mt-90">
          <img
            style={{ objectFit: "cover", height: '700px', width: '520px'}}
            src="/images/media/img_01.jpeg"
            alt="shape"
            className="lazy-img" 
          ...
          <div className="card-one" data-aos="fade-up" data-aos-delay="250">
            ...
            <div className="name fs-18 fw-500 tx-dark mb-10">
              - R.K. Kandoi, <span className="opacity-50">Founder</span>
            </div>
            <p className="fs-18 m0">
            We promptly address all granite-related inquiries to serve you better.
            </p>
          </div>{" "}
          {/* /.card-one */}
        </div>{" "}
