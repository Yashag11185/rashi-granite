    ...
    <>
      ...
      <div className="img-gallery md-mt-60 ">
        <div className="row align-items-center" data-aos="fade-right">
          <div className="col-6">
            <img
              src="/images/media/img_79.jpeg"
              alt="media"
              className="lazy-img mt-40 mb-40 lg-mt-20 lg-mb-20"  style={{ height: '300px' }} 
            />
            <img
              src="/images/media/img_80.jpeg"
              alt="media"
              className="lazy-img ms-auto mt-40 mb-40 lg-mt-20 lg-mb-20" style={{ height: '260px' }} 
            />
          </div>
          <div className="col-6">
            <img
              ...
              alt="media"
              className="lazy-img mt-40 mb-40 lg-mt-20 lg-mb-20" style={{ height: '330px' }} 
            />
          </div>
        </div>
        {/* End .row */}
